...
<?php if ($user->user_id->Visible) { // user_id ?>
	<div id="r_user_id" class="form-group">
		<label id="elh_user_user_id" class="<?php echo $user_edit->LeftColumnClass ?>"><?php echo $user->user_id->FldCaption() ?></label>
		<div class="<?php echo $user_edit->RightColumnClass ?>"><div<?php echo $user->user_id->CellAttributes() ?>>
<span id="el_user_user_id">
<span<?php echo $user->user_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $user->user_id->EditValue ?></p></span>
</span>
...
<?php echo $user->user_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($user->username->Visible) { // username ?>
	<div id="r_username" class="form-group">
		<label id="elh_user_username" for="x_username" class="<?php echo $user_edit->LeftColumnClass ?>"><?php echo $user->username->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<input type="password" data-field="x_password" name="x_password" id="x_password" value="<?php echo $user->password->EditValue ?>" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($user->password->getPlaceHolder()) ?>"<?php echo $user->password->EditAttributes() ?>>
</span>
