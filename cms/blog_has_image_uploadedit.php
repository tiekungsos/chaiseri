...
$blog_has_image_upload_edit = NULL; // Initialize page object first

class cblog_has_image_upload_edit extends cblog_has_image_upload {
	...
	// Page object name
	var $PageObjName = 'blog_has_image_upload_edit';
...
// Create page object
if (!isset($blog_has_image_upload_edit)) $blog_has_image_upload_edit = new cblog_has_image_upload_edit();

// Page init
$blog_has_image_upload_edit->Page_Init();

// Page main
$blog_has_image_upload_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$blog_has_image_upload_edit->Page_Render();
?>
...
var CurrentForm = fblog_has_image_uploadedit = new ew_Form("fblog_has_image_uploadedit", "edit");

// Validate form
fblog_has_image_uploadedit.Validate = function() {
...
fblog_has_image_uploadedit.Form_CustomValidate = 
...
fblog_has_image_uploadedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $blog_has_image_upload_edit->ShowPageHeader(); ?>
<?php
$blog_has_image_upload_edit->ShowMessage();
?>
<form name="fblog_has_image_uploadedit" id="fblog_has_image_uploadedit" class="<?php echo $blog_has_image_upload_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($blog_has_image_upload_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $blog_has_image_upload_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="blog_has_image_upload">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($blog_has_image_upload_edit->IsModal) ?>">
...
<?php if ($blog_has_image_upload->blog_id->Visible) { // blog_id ?>
	<div id="r_blog_id" class="form-group">
		<label id="elh_blog_has_image_upload_blog_id" for="x_blog_id" class="<?php echo $blog_has_image_upload_edit->LeftColumnClass ?>"><?php echo $blog_has_image_upload->blog_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $blog_has_image_upload_edit->RightColumnClass ?>"><div<?php echo $blog_has_image_upload->blog_id->CellAttributes() ?>>
...
<input type="hidden" data-table="blog_has_image_upload" data-field="x_blog_id" name="x_blog_id" id="x_blog_id" value="<?php echo ew_HtmlEncode($blog_has_image_upload->blog_id->CurrentValue) ?>">
<?php echo $blog_has_image_upload->blog_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($blog_has_image_upload->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_blog_has_image_upload_id" for="x_id" class="<?php echo $blog_has_image_upload_edit->LeftColumnClass ?>"><?php echo $blog_has_image_upload->id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $blog_has_image_upload_edit->RightColumnClass ?>"><div<?php echo $blog_has_image_upload->id->CellAttributes() ?>>
...
<input type="hidden" data-table="blog_has_image_upload" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($blog_has_image_upload->id->CurrentValue) ?>">
<?php echo $blog_has_image_upload->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
<?php if (!$blog_has_image_upload_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $blog_has_image_upload_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $blog_has_image_upload_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fblog_has_image_uploadedit.Init();
</script>
<?php
$blog_has_image_upload_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$blog_has_image_upload_edit->Page_Terminate();
?>
