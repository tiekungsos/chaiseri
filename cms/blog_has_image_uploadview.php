...
$blog_has_image_upload_view = NULL; // Initialize page object first

class cblog_has_image_upload_view extends cblog_has_image_upload {
	...
	// Page object name
	var $PageObjName = 'blog_has_image_upload_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["blog_id"] <> "") {
				...
				$sReturnUrl = "blog_has_image_uploadlist.php"; // Return to list
			}
			if (@$_GET["id"] <> "") {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "blog_has_image_uploadlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "blog_has_image_uploadlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($blog_has_image_upload_view)) $blog_has_image_upload_view = new cblog_has_image_upload_view();

// Page init
$blog_has_image_upload_view->Page_Init();

// Page main
$blog_has_image_upload_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$blog_has_image_upload_view->Page_Render();
?>
...
var CurrentForm = fblog_has_image_uploadview = new ew_Form("fblog_has_image_uploadview", "view");

// Form_CustomValidate event
fblog_has_image_uploadview.Form_CustomValidate = 
...
fblog_has_image_uploadview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $blog_has_image_upload_view->ExportOptions->Render("body") ?>
<?php
	foreach ($blog_has_image_upload_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $blog_has_image_upload_view->ShowPageHeader(); ?>
<?php
$blog_has_image_upload_view->ShowMessage();
?>
<form name="fblog_has_image_uploadview" id="fblog_has_image_uploadview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($blog_has_image_upload_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $blog_has_image_upload_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="blog_has_image_upload">
<input type="hidden" name="modal" value="<?php echo intval($blog_has_image_upload_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($blog_has_image_upload->blog_id->Visible) { // blog_id ?>
	<tr id="r_blog_id">
		<td class="col-sm-2"><span id="elh_blog_has_image_upload_blog_id"><?php echo $blog_has_image_upload->blog_id->FldCaption() ?></span></td>
...
<?php echo $blog_has_image_upload->blog_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($blog_has_image_upload->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_blog_has_image_upload_id"><?php echo $blog_has_image_upload->id->FldCaption() ?></span></td>
...
<?php echo $blog_has_image_upload->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fblog_has_image_uploadview.Init();
</script>
<?php
$blog_has_image_upload_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$blog_has_image_upload_view->Page_Terminate();
?>
