...
<?php if ($user->user_id->Visible) { // user_id ?>
	<tr id="r_user_id">
		<td class="col-sm-2"><span id="elh_user_user_id"><?php echo $user->user_id->FldCaption() ?></span></td>
...
<?php if ($user->date_create->Visible) { // date_create ?>
	<tr id="r_date_create">
		<td class="col-sm-2"><span id="elh_user_date_create"><?php echo $user->date_create->FldCaption() ?></span></td>
		<td data-name="date_create"<?php echo $user->date_create->CellAttributes() ?>>
<span id="el_user_date_create">
<span<?php echo $user->date_create->ViewAttributes() ?>>
<?php echo $user->date_create->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
