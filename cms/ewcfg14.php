...
define("EW_PROJECT_ID", "{5E0F01B1-4565-4ABF-9ED4-51691E2A8222}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'FgnGE4R6pvgxzBef', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "chai", "qs" => "`", "qe" => "`");
...
define("EW_ADMIN_PASSWORD", "thanapon", TRUE); // Administrator password
