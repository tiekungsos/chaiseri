...
class cuser_add extends cuser {
	...
	function LoadFormValues() {
		...
		if (!$this->date_create->FldIsDetailKey) {
			...
			$this->date_create->CurrentValue = ew_UnFormatDateTime($this->date_create->CurrentValue, 1);
		}
	}
	...
	function AddRow($rsold = NULL) {
		...
		// date_create
		$this->date_create->SetDbValueDef($rsnew, ew_CurrentDate(), NULL);
...
<?php if ($user->username->Visible) { // username ?>
	<div id="r_username" class="form-group">
		<label id="elh_user_username" for="x_username" class="<?php echo $user_add->LeftColumnClass ?>"><?php echo $user->username->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($user->password->Visible) { // password ?>
	<div id="r_password" class="form-group">
		<label id="elh_user_password" for="x_password" class="<?php echo $user_add->LeftColumnClass ?>"><?php echo $user->password->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
