...
<?php if ($user->user_id->Visible) { // user_id ?>
		<th class="<?php echo $user->user_id->HeaderCellClass() ?>"><span id="elh_user_user_id" class="user_user_id"><?php echo $user->user_id->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($user->date_create->Visible) { // date_create ?>
		<th class="<?php echo $user->date_create->HeaderCellClass() ?>"><span id="elh_user_date_create" class="user_date_create"><?php echo $user->date_create->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($user->user_id->Visible) { // user_id ?>
		<td<?php echo $user->user_id->CellAttributes() ?>>
<span id="el<?php echo $user_delete->RowCnt ?>_user_user_id" class="user_user_id">
...
<?php } ?>
<?php if ($user->date_create->Visible) { // date_create ?>
		<td<?php echo $user->date_create->CellAttributes() ?>>
<span id="el<?php echo $user_delete->RowCnt ?>_user_date_create" class="user_date_create">
