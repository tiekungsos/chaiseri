...
class cuser extends cTable {
	...
	function __construct() {
		...
		// password
		$this->password = new cField('user', 'user', 'x_password', 'password', '`password`', '`password`', 200, -1, FALSE, '`password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'PASSWORD');
		$this->password->Sortable = TRUE; // Allow sort
		$this->fields['password'] = &$this->password;

		// date_create
		$this->date_create = new cField('user', 'user', 'x_date_create', 'date_create', '`date_create`', ew_CastDateFieldForLike('`date_create`', 1, "DB"), 135, 1, FALSE, '`date_create`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
