...
<?php if ($user->user_id->Visible) { // user_id ?>
	<?php if ($user->SortUrl($user->user_id) == "") { ?>
		<th data-name="user_id" class="<?php echo $user->user_id->HeaderCellClass() ?>"><div id="elh_user_user_id" class="user_user_id"><div class="ewTableHeaderCaption"><?php echo $user->user_id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="user_id" class="<?php echo $user->user_id->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->user_id) ?>',1);"><div id="elh_user_user_id" class="user_user_id">
...
<?php if ($user->password->Visible) { // password ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($user->date_create->Visible) { // date_create ?>
	<?php if ($user->SortUrl($user->date_create) == "") { ?>
		<th data-name="date_create" class="<?php echo $user->date_create->HeaderCellClass() ?>"><div id="elh_user_date_create" class="user_date_create"><div class="ewTableHeaderCaption"><?php echo $user->date_create->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="date_create" class="<?php echo $user->date_create->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->date_create) ?>',1);"><div id="elh_user_date_create" class="user_date_create">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->date_create->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($user->date_create->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->date_create->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<?php echo $user->password->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($user->date_create->Visible) { // date_create ?>
		<td data-name="date_create"<?php echo $user->date_create->CellAttributes() ?>>
<span id="el<?php echo $user_list->RowCnt ?>_user_date_create" class="user_date_create">
<span<?php echo $user->date_create->ViewAttributes() ?>>
<?php echo $user->date_create->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
