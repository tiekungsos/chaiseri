...
//
// Table class for image_upload
//
class cimage_upload extends cTable {
	var $location;
	var $date_create;
	var $blog_id;
	var $image_id;
	...
	function __construct() {
		...
		$this->TableVar = 'image_upload';
		$this->TableName = 'image_upload';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`image_upload`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// location
		$this->location = new cField('image_upload', 'image_upload', 'x_location', 'location', '`location`', '`location`', 200, -1, TRUE, '`location`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->location->Sortable = TRUE; // Allow sort
		$this->fields['location'] = &$this->location;

		// date_create
		$this->date_create = new cField('image_upload', 'image_upload', 'x_date_create', 'date_create', '`date_create`', ew_CastDateFieldForLike('`date_create`', 0, "DB"), 135, 0, FALSE, '`date_create`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// blog_id
		$this->blog_id = new cField('image_upload', 'image_upload', 'x_blog_id', 'blog_id', '`blog_id`', '`blog_id`', 3, -1, FALSE, '`blog_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->blog_id->Sortable = TRUE; // Allow sort
		$this->fields['blog_id'] = &$this->blog_id;

		// image_id
		$this->image_id = new cField('image_upload', 'image_upload', 'x_image_id', 'image_id', '`image_id`', '`image_id`', 3, -1, FALSE, '`image_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`image_upload`";
	}
	...
	function Insert(&$rs) {
		...
		if ($bInsert) {
			...
			$rs['image_id'] = $this->image_id->DbValue;
		}
		return $bInsert;
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "image_uploadedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "image_uploadadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("image_uploadview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("image_uploadview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "image_uploadadd.php?" . $this->UrlParm($parm);
		else
			$url = "image_uploadadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("image_uploadedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("image_uploadadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("image_uploaddelete.php", $this->UrlParm());
	}
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			$isPost = ew_IsPost();
			if ($isPost && isset($_POST["image_id"]))
				$arKeys[] = $_POST["image_id"];
			elseif (isset($_GET["image_id"]))
				$arKeys[] = $_GET["image_id"];
			else
	...
	function LoadListRowValues(&$rs) {
		$this->location->Upload->DbValue = $rs->fields('location');
