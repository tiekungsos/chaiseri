...
class cproduct_add extends cproduct {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "productview.php")
	...
	function NewRow() {
		...
		$row['name_th'] = $this->name_th->CurrentValue;
		$row['description_th'] = $this->description_th->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// brand
		$this->brand->SetDbValueDef($rsnew, $this->brand->CurrentValue, NULL, FALSE);
...
var CurrentForm = fproductadd = new ew_Form("fproductadd", "add");
...
fproductadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fproductadd.Lists["x_type"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fproductadd.Lists["x_type"].Options = <?php echo json_encode($product_add->type->Options()) ?>;
fproductadd.Lists["x_brand"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fproductadd.Lists["x_brand"].Options = <?php echo json_encode($product_add->brand->Options()) ?>;
...
?>
<form name="fproductadd" id="fproductadd" class="<?php echo $product_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($product_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $product_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="product">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($product_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($product->name_th->Visible) { // name_th ?>
	<div id="r_name_th" class="form-group">
		<label id="elh_product_name_th" for="x_name_th" class="<?php echo $product_add->LeftColumnClass ?>"><?php echo $product->name_th->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $product_add->RightColumnClass ?>"><div<?php echo $product->name_th->CellAttributes() ?>>
...
<?php if ($product->description_th->Visible) { // description_th ?>
	<div id="r_description_th" class="form-group">
		<label id="elh_product_description_th" for="x_description_th" class="<?php echo $product_add->LeftColumnClass ?>"><?php echo $product->description_th->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $product_add->RightColumnClass ?>"><div<?php echo $product->description_th->CellAttributes() ?>>
...
<?php if ($product->name_en->Visible) { // name_en ?>
	<div id="r_name_en" class="form-group">
		<label id="elh_product_name_en" for="x_name_en" class="<?php echo $product_add->LeftColumnClass ?>"><?php echo $product->name_en->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $product_add->RightColumnClass ?>"><div<?php echo $product->name_en->CellAttributes() ?>>
...
<?php if ($product->description_en->Visible) { // description_en ?>
	<div id="r_description_en" class="form-group">
		<label id="elh_product_description_en" for="x_description_en" class="<?php echo $product_add->LeftColumnClass ?>"><?php echo $product->description_en->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $product_add->RightColumnClass ?>"><div<?php echo $product->description_en->CellAttributes() ?>>
...
<?php if ($product->size->Visible) { // size ?>
	<div id="r_size" class="form-group">
		<label id="elh_product_size" for="x_size" class="<?php echo $product_add->LeftColumnClass ?>"><?php echo $product->size->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $product_add->RightColumnClass ?>"><div<?php echo $product->size->CellAttributes() ?>>
...
<?php if ($product->type->Visible) { // type ?>
	<div id="r_type" class="form-group">
		<label id="elh_product_type" for="x_type" class="<?php echo $product_add->LeftColumnClass ?>"><?php echo $product->type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $product_add->RightColumnClass ?>"><div<?php echo $product->type->CellAttributes() ?>>
...
<?php if ($product->brand->Visible) { // brand ?>
	<div id="r_brand" class="form-group">
		<label id="elh_product_brand" for="x_brand" class="<?php echo $product_add->LeftColumnClass ?>"><?php echo $product->brand->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $product_add->RightColumnClass ?>"><div<?php echo $product->brand->CellAttributes() ?>>
...
<?php if ($product->img->Visible) { // img ?>
	<div id="r_img" class="form-group">
		<label id="elh_product_img" class="<?php echo $product_add->LeftColumnClass ?>"><?php echo $product->img->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $product_add->RightColumnClass ?>"><div<?php echo $product->img->CellAttributes() ?>>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $product_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
