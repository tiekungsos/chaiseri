...
fblogview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($blog_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($blog->blog_id->Visible) { // blog_id ?>
	<tr id="r_blog_id">
		<td class="col-sm-2"><span id="elh_blog_blog_id"><?php echo $blog->blog_id->FldCaption() ?></span></td>
...
<?php if ($blog->name->Visible) { // name ?>
	<tr id="r_name">
		<td class="col-sm-2"><span id="elh_blog_name"><?php echo $blog->name->FldCaption() ?></span></td>
		<td data-name="name"<?php echo $blog->name->CellAttributes() ?>>
<span id="el_blog_name">
<span<?php echo $blog->name->ViewAttributes() ?>>
<?php echo $blog->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($blog->description_head->Visible) { // description_head ?>
	<tr id="r_description_head">
		<td class="col-sm-2"><span id="elh_blog_description_head"><?php echo $blog->description_head->FldCaption() ?></span></td>
...
<?php echo $blog->description_head->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($blog->description->Visible) { // description ?>
	<tr id="r_description">
		<td class="col-sm-2"><span id="elh_blog_description"><?php echo $blog->description->FldCaption() ?></span></td>
...
<?php echo $blog->description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($blog->date->Visible) { // date ?>
	<tr id="r_date">
		<td class="col-sm-2"><span id="elh_blog_date"><?php echo $blog->date->FldCaption() ?></span></td>
		<td data-name="date"<?php echo $blog->date->CellAttributes() ?>>
<span id="el_blog_date">
<span<?php echo $blog->date->ViewAttributes() ?>>
<?php echo $blog->date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($blog->date_create->Visible) { // date_create ?>
	<tr id="r_date_create">
		<td class="col-sm-2"><span id="elh_blog_date_create"><?php echo $blog->date_create->FldCaption() ?></span></td>
...
<?php echo $blog->date_create->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($blog->image_upload->Visible) { // image_upload ?>
	<tr id="r_image_upload">
		<td class="col-sm-2"><span id="elh_blog_image_upload"><?php echo $blog->image_upload->FldCaption() ?></span></td>
		<td data-name="image_upload"<?php echo $blog->image_upload->CellAttributes() ?>>
<span id="el_blog_image_upload">
<span<?php echo $blog->image_upload->ViewAttributes() ?>>
<?php echo ew_GetFileViewTag($blog->image_upload, $blog->image_upload->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($blog->image_upload_head->Visible) { // image_upload_head ?>
	<tr id="r_image_upload_head">
		<td class="col-sm-2"><span id="elh_blog_image_upload_head"><?php echo $blog->image_upload_head->FldCaption() ?></span></td>
...
<?php echo ew_GetFileViewTag($blog->image_upload_head, $blog->image_upload_head->ViewValue) ?>
</span>
</span>
</td>
	</tr>
