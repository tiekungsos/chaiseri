   ...
   ?>
    ...
    <div class="col-md-12 col-sm-12 about-image top_30">
            ...
            <div class="top_30" align="center">
                <h1><?php echo $row['description_th']; ?></h1>
            </div>
            <div align="center"> <br>        
            <?php if($row['type'] == 1) { ?>
                <h1><?php echo 'ประเภท ขวดแก้ว  ขนาด '.$row['size'] ?> ML</h1>     
             <?php } 
                else if($row['type'] == 2) { ?>
                <h1><?php echo 'ประเภท ขวดPET  ขนาด '.$row['size'] ?> ML</h1>    
            <?php } 
                 else if($row['type'] == 3) { ?>
                <h1><?php echo 'ประเภท แกลอนพาสติก  ขนาด '.$row['size'] ?> KG</h1>   
             <?php } 
                else if($row['type'] == 4) { ?>
                <h1><?php echo 'ประเภท แบบปิ๊บ  ขนาด '.$row['size'] ?> KG</h1>   
             <?php } ?><br> <br> 
             </div>
    </div>
